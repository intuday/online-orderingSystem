...
import {
  X, Gift, Check, Sparkles, Tag, ChevronRight,
} from "lucide-react";
import { useOfferEngine } from "@/store/offer-engine";
import { formatCurrency } from "@/lib/utils";
import type { RewardChoice } from "@/lib/types/offers";
...
export default function OfferRewardSelector() {
  ...
  if (!showRewardSelector || !activeOffer) return null;
        ...
        >
          ...
          <div className="p-5 space-y-4">
                    ...
                    <div className="flex-1 text-left">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="bg-green-100 text-green-700 text-[9px] font-bold px-1.5 py-0.5 rounded-full">
                          SAVE{" "}
                          {formatCurrency(
                            choice.originalPrice - choice.promoPrice
                          )}
                        </span>
                      </div>
                    </div>
            ...
            <motion.button
              ...
              onClick={handleClaim}
              disabled={!selected}
              className={`w-full h-13 rounded-xl font-semibold flex items-center justify-center gap-2 transition-all py-3.5 ${
                selected
